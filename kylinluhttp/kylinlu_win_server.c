/*使用tinyhttpd-0.1.0版本代码，为www.kylinlu.win写服务器*/
/**
*网址：www.kylinlu.win
*作者：kylin
*邮箱：luqilin1234@126.com
*环境：该服务器在阿里云镜像CentOS 7.2 64位系统编译运行通过
*/
...
#define SERVER_STRING "Server: kylinluHttp/0.1.0\r\n"
...
int main(int argc,char*argv)
{
	...
	if (argc < 2)
	{
		port = 80; //默认采用80端口号，域名进行访问时可以不用输入端口号
	}
	else
	{
		port = atoi(argv[1]);
